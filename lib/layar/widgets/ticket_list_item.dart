...
class TicketListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color surfaceColor = isDarkMode ? const Color(0xFF1D2936) : Colors.white;
        ...
        children: [
          Row(
            ...
            children: [
              Row(
                children: [
                  Text(ticket.id, style: TextStyle(color: subtextColor, fontSize: 12, fontWeight: FontWeight.bold)),
                  const SizedBox(width: 8),
                  Container(width: 4, height: 4, decoration: BoxDecoration(shape: BoxShape.circle, color: Colors.grey[600])),
                  const SizedBox(width: 8),
                  Text(ticket.timeAgo, style: TextStyle(color: subtextColor, fontSize: 12)),
                ],
              ),
              Container(
          ...
          Chip(
            ...
            labelStyle: TextStyle(color: isDarkMode ? Colors.grey[300] : Colors.grey[700], fontSize: 12),
