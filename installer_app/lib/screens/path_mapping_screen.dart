...
import 'package:installer_app/data/models/installation.dart';
...
class PathMappingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Column(
          children: [
            Text('Step 2 of 4', style: TextStyle(fontSize: 12, color: Theme.of(context).textTheme.bodySmall?.color)),
            Text('Path Mapping', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
          ],
        ),
        centerTitle: true,
        actions: [
                    ...
                    Center(
                     ...
                     Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                           Text('Mapped Points', style: Theme.of(context).textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.bold)),
                           Chip(
                            label: Text('${installation.mappedPoints.length} Points'),
  ...
  IconData _getIconForPoint(String title) {
    ...
    if (title.contains('Pole')) return Icons.podium;
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Text(timestamp, style: TextStyle(fontSize: 12, color: Theme.of(context).textTheme.bodySmall?.color)),
                        ],
                      ),
                      ...
                      Row(
                        children: [
                          ...
                          Text(coordinates, style: TextStyle(fontSize: 12, color: Theme.of(context).textTheme.bodySmall?.color, fontFamily: 'monospace')),
                        ],
                      ),
                      if (imageUrl != null) ...[
                        const SizedBox(height: 8),
